...
% 	\end{table}
%	\vspace{2mm}
%	\small{MATH 233 Final Presentation} 
%	\vspace{-3mm}
%}
...
\begin{frame}{Motivation}
	In medical imaging, radiography typically uses apertures to modulate the radiation emitted by an x-ray source. \\ \smallskip \pause
	\only<2->{\textcolor{red}{\textbf{Problem:}} With more complicated apertures, a decoding procedure is necessary to reconstruct the image.
	\bigskip 
	\begin{figure}
